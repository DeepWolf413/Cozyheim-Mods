...
{
    internal class SkillResistanceSpirit : SkillBase
    {
        public static SkillResistanceSpirit Instance;

        public SkillResistanceSpirit(int maxLevel, float bonusPerLevel, string iconName, string displayName,
