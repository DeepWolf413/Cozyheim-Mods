...
namespace DeepWolf.CharacterProgressionMod
{
    internal class SkillMining : SkillBase
    {
        ...
        public SkillMining(int maxLevel, float bonusPerLevel, string iconName, string displayName, string unit = "",
        ...
        private class PatchClass
        {
            ...
            private static void ItemData_GetDamage_Mining_Postfix(ItemDrop.ItemData __instance,
