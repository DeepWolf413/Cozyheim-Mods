...
namespace CharacterProgressionMod
{
    internal class SkillWoodcutting : SkillBase
    {
        ...
        public SkillWoodcutting(int maxLevel, float bonusPerLevel, string iconName, string displayName,
                                string unit = "",
        ...
        private class PatchClass
        {
            ...
            private static void ItemData_GetDamage_Woodcutting_Postfix(ItemDrop.ItemData __instance,
